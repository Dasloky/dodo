...
if current_page == "קצת עידו":
    ...
    if st.button("כדי שתדע את מקומך קצת יותר טוב ✨"):
        reasons = ["תמיד יש לי חיוך טיפשי בגללך", "אני זכיתי בך כל כך", "החיוך שלך גורם לרגל שלי לקפץ", "אני מתה על הלחיים החמודות שלך","אתה המאכל האהוב עלי","אני רוצה למחוץ אותך","אתה גורם לי להרגיש דברים🤭"
				   ,"אני רוצה להתכסות איתך בפוך","אני נהנת מכל רגע איתך","אתה גורם לי לצחוק גם אם אני עצובה",
				   "אני אוהבת אותך הכי בעולם","תתחתן איתי פליז?","אתה האישה האהובה עלי","אני מתה על העיניים שלך","אני אוהבת להקשיב לך גם אם זה על דברים שאני לא מבינה","אתה החבר הכי טוב שאפשר לבקש","אני מתההה על השיער שלך"]
