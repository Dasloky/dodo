...
# --- CSS חם, נקי ומותאם למובייל (ללא כחול כהה, ללא טקסט לבן) ---
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Assistant:wght@300;400;700&display=swap');

:root {
    --soft-cream: #FFF9F5; /* רקע קרם עדין */
    --warm-text: #432818;  /* טקסט חום כהה עדין - לא לבן */
    --accent-pink: #ffb5a7;
    --card-bg: #ffffff;
}
...
/* עיצוב כפתורי בחירה (Selectbox) שיהיה כהה וקריא */
div[data-testid="stSelectbox"] label {
    color: var(--warm-text) !important;
}

/* מניעת טקסט לבן במדדים */
