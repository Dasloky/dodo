...
if current_page == "קצת עידו":
    ...
    if st.session_state.clicks < TARGET_CLICKS:
        ...
        <div style="background: white; padding: 30px; border-radius: 20px; border: 2px dashed #f08080; text-align: right; line-height: 1.8; direction: rtl; color: #333; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
            ...
            <p>כשאני עבדתי על המתנת יום הולדת שלך חפרתי לכל בן אדם אפשרי לבדוק מה הכי כדאי לעשות לך והיו לי כמה רעיונות וחלקם היו יותר קשים למימוש עקב המצב הביטחוני במדינת ישראל 🤪🚀🗡️⚔️.</p>
            <p>וגם כשעבדתי על המתנות שלך ראשאל זרק הערה שאני משקיעה קצת יותר מדי למישהו שאני יוצאת איתו רק חודשיים, ולרגע חשבתי על זה ופשוט הבנתי שבשום שניה בשבילי זה לא הרגיש יותר מדי כי אני באמת כל כך נהנית לעשות לך דברים - גם אם זה יצירות או אתרים שאני לא כזה טובה בהם 🥲🩵💛.</p>
            
            <div style="background: #fff5f5; border-right: 5px solid #f08080; padding: 15px; margin: 20px 0; border-radius: 5px; font-weight: bold; text-align: center;">
            ...
            <p>אחרי החיבוק החמים והנעים שקיבלתי, אני אתחיל קצת קצת קצת לרדת עליך 😝🚨.</p>
            <p>אז עידו, אני חושבת שפתחת איתי איזו תחרות שנ"צים! כי מתחילת המלחמה, במקום שאני אגיד לכולם "חבר שלי ❤️ מסכן לוחם סובל בלבנון אני פוחדת עליו" 🥶, אתה כל יום דופק שנ"צים 🤨. באמת אני אתחיל איתך תחרות מי עושה יותר שנ"צים במהלך היום 😴.</p>
            <p>עוד דבר שאני לוקחת בשיחות שלנו כמובן מאליו זה שאני עושה 20 דברים בו זמנית, אבל האדון שמדבר פה מתחיל לפתוח לי יוטיוב בזמן השיחה וגם לעשות דברים אחרים 🧐. וואלה מתלונן אבל בעצמך עושה את אותו הדבר 🫤.</p>
            <p>באמת ולא רק זה - תמיד מתלונן לי שאני לא נותנת לו לדבר, אבל ברגע שאני מחליטה לשתוק ומחזיקה את עצמי הכי חזק שיש, צוחקת ונחנקת ממים כדי לא להשמיע קול - גם על זה אתה מתלונן! פתאום לא כיף לך. באמת שום דבר שאני עושה לא מתאים לך 🫩 איזו אישה 💅.</p>
            
            <hr style="border: 0; border-top: 1px dotted #f08080; margin: 25px 0;">
            
            <p>אז <b>דיווה שלי 👩🏼‍🎤 חיים שלי ❤️ נשמה שלי 🌬️</b>, אתה אחד הדברים הטובים ביותר שקרו לי. כנראה באמת הצלתי איזה 10 קיסרים בחיים הקודמים שלי כדי לזכות בך, כי עם חבר כזה הייתי מצילה גם בחיים האלה 10 קיסרים אם אקבל אותך בחיים הבאים שלי 🥇🎎.</p>
            <p>אני אוהבת אותך ממש ממש ממש ופיתחת אצלי רגשות שלא ידעתי שקיימים. ממש הפשרת את הלב קרח שלי ❄️💙. אני מתגעגעת אליך כל הזמן שאתה רחוק ורק רוצה שתהיה קרוב.</p>
            <p>אז כדי להתמודד עם צער שכזה אני אצטרך להשתמש בנשקים ממש מסוכנים שזה שיחות וידיאו 🤭 ואם אפילו צריך אני אבלגן את השיער שלי כדי להשאיר אותך עוד ❤️ מה אני אעשה, מדי פעם אני פשוט מרושעת... אבל אתה אמרת בעצמך שאתה רוצה להציק למי שאתה אוהב 🤪📈.</p>
            
            <p style="font-size: 1.3em; font-weight: bold; color: #f08080; text-align: center; margin-top: 20px;">
